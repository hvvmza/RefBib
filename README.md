...
## 🚀 Getting Started: Download and Install RefBib
...
### Step 4: Install RefBib

1. Double-click the downloaded `.exe` installer file.  
2. You might see a Windows security warning. Click “Run” to continue.  
3. Follow the instructions in the setup wizard:  
   - Choose an install location (the default is usually fine).  
   - Click “Install” to begin.  
4. Once installation finishes, select “Finish” to close the wizard.
...
- Click “Save BibTeX” to save all extracted entries to a `.bib` file.  
- This file can be used with tools like Zotero, Overleaf, or any LaTeX editor.
